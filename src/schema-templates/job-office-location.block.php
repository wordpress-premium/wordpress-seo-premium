...
<div class={{class-name}}>
	...
	{{rich-text name="address" tag="p" placeholder="<?php esc_attr_e( 'Enter street address', 'wordpress-seo-premium' ); ?>"}}
	{{variable-tag-rich-text name="postal-code-title" tags=[ "h4", "h2", "h3", "h5", "h6", "strong" ] }}
	{{rich-text name="postal-code" tag="p" placeholder="<?php esc_attr_e( 'Enter postal code', 'wordpress-seo-premium' ); ?>"}}
	{{variable-tag-rich-text name="city-title" tags=[ "h4", "h2", "h3", "h5", "h6", "strong" ] }}
	{{rich-text name="city" tag="p" placeholder="<?php esc_attr_e( 'Enter city', 'wordpress-seo-premium' ); ?>"}}
	{{variable-tag-rich-text name="region-title" tags=[ "h4", "h2", "h3", "h5", "h6", "strong" ] }}
	{{rich-text name="region" tag="p" placeholder="<?php esc_attr_e( 'Enter region', 'wordpress-seo-premium' ); ?>"}}
	{{variable-tag-rich-text name="country-title" tags=[ "h4", "h2", "h3", "h5", "h6", "strong" ] }}
	{{rich-text name="country" tag="p" placeholder="<?php esc_attr_e( 'Enter country', 'wordpress-seo-premium' ); ?>"}}
</div>
