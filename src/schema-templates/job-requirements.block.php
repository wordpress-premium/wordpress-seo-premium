...
{{block name="yoast/job-requirements" title="<?php esc_attr_e( 'Requirements', 'wordpress-seo-premium' ); ?>" category="yoast-recommended-job-blocks" parent=[ "yoast/job-posting" ] supports={"multiple": false} }}
