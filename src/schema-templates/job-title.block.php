...
{{block name="yoast/job-title" title="<?php esc_attr_e( 'Job title', 'wordpress-seo-premium' ); ?>" category="yoast-required-job-blocks" parent=[ "yoast/job-posting" ] supports={"multiple": false} }}
